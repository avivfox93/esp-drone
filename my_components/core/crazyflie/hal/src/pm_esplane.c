...
void pmTask(void *param)
{
  ...
  ws2812b_write_hsv(0, ((int16_t)batteryLevel*120)/100, 100, 15);
  ws2812b_refresh();
//  DEBUG_PRINTD("batteryLevel=%u extBatteryVoltageMV=%u, Hue=%u \n", batteryLevel, extBatteryVoltageMV, ((int16_t)batteryLevel*120)/100);
#ifdef DEBUG_EP2
