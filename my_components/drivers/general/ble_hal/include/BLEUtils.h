...
void enable_ble_log(bool on);

//#define log_v(msg,...) ESP_LOGV("BLEUtils",msg,__VA_ARGS__);
//#define log_e(msg,...) ESP_LOGE("BLEUtils",msg,__VA_ARGS__);
//#define log_w(msg,...) ESP_LOGW("BLEUtils",msg,__VA_ARGS__);
//#define log_i(msg,...) ESP_LOGI("BLEUtils",msg,__VA_ARGS__);
//#define log_d(msg,...) ESP_LOGD("BLEUtils",msg,__VA_ARGS__);
