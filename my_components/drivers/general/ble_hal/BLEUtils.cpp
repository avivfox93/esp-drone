...
static const char* TAG = "BLEUtils";
...
//	if(log_on)
//		LOGGER_LOG << "(BLE) - " << msg << Logger.RESET << std::endl;
}
void log_e(const char* msg...){
//	if(log_on)
//		LOGGER_ERROR << "(BLE) - " << msg << Logger.RESET << std::endl;
}

void log_w(const char* msg...){
//	if(log_on)
//		LOGGER_WARNING << "(BLE) - " << msg << Logger.RESET << std::endl;
}

void log_i(const char* msg...){
//	if(log_on)
//		LOGGER_INFO << "(BLE) - " << msg << Logger.RESET << std::endl;
}
